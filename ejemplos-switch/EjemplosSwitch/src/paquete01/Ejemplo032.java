...
public class Ejemplo032 {
    ...
    public static void main(String[] args) {
        ...
        // nombre = "atacames"
        String nombre2 = nombre.substring(0,1);//se utiliza el substring como otro metodo para convertir el char a mayusculas o minusculas
        char valor = nombre.charAt(0); // obtener el primer caracter de una
        nombre = nombre.toLowerCase(); // cadena
        //  L   o   j   a
        //  0   1   2   3
        switch(valor){
            case 'a':
           ...
           System.out.printf("Nombre con inicial %s de %s\n", 
                        nombre2.toUpperCase(), nombre.toLowerCase());//aqui se usa la variable hecha por el substring
                break;
